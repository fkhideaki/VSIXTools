...
namespace VSIXTools
{
    ...
    [Guid(VSIXToolsPackage.PackageGuidString)]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    public sealed class VSIXToolsPackage : AsyncPackage
    {
        /// <summary>
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await TortoiseDiffCmd.InitializeAsync(this);
            await TortoiseLogCmd.InitializeAsync(this);
            await TortoiseDiffDirCmd.InitializeAsync(this);
